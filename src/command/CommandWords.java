...
public class CommandWords {
	...
	/**
	 * Initalizes the command words. Will be called if a function
	 * in this class requires it, so it does not have to be called
	 * prior to other uses of this class.
	 */
	public static void initCommandWords() {
